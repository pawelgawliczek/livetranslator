          ...
          {loading ? (
            ...
            <>
              ...
              <div className="bg-gray-700 rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-white font-medium">{data.user.email}</div>
                  </div>
                  <div>
                    <div className="text-gray-400 text-sm mb-1">Display Name</div>
                    <div className="text-white font-medium">{data.user.display_name}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    <div className="text-gray-400 text-sm mb-1">Rooms Created</div>
                    <div className="text-white font-medium">{data.summary.room_count}</div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-700 rounded-lg p-6">
                  <div className="text-gray-400 text-sm mb-2">STT Cost</div>
                  <div className="text-white text-2xl font-bold">
                    {formatCurrency(data.summary.stt_cost_usd)}
                  </div>
                </div>
                <div className="bg-gray-700 rounded-lg p-6">
                  <div className="text-gray-400 text-sm mb-2">MT Cost</div>
                  <div className="text-white text-2xl font-bold">
              ...
              {data.daily_costs && data.daily_costs.length > 0 && (
                <div className="bg-gray-700 rounded-lg p-6">
                  <h4 className="text-lg font-semibold text-white mb-4">Daily Cost Trend</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {data.provider_usage.stt && Object.keys(data.provider_usage.stt).length > 0 && (
                  <div className="bg-gray-700 rounded-lg p-6">
                    <h4 className="text-lg font-semibold text-white mb-4">STT Provider Usage</h4>
                      ...
                      {Object.entries(data.provider_usage.stt).map(([provider, usage]) => (
                        <div key={provider}>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-gray-400 text-sm">{usage.percentage}%</span>
                          </div>
                ...
                {data.provider_usage.mt && Object.keys(data.provider_usage.mt).length > 0 && (
                  <div className="bg-gray-700 rounded-lg p-6">
                    <h4 className="text-lg font-semibold text-white mb-4">MT Provider Usage</h4>
                    <div className="space-y-3">
              ...
              {data.rooms && data.rooms.length > 0 && (
                <div className="bg-gray-700 rounded-lg p-6">
                  <h4 className="text-lg font-semibold text-white mb-4">Rooms Created ({data.rooms.length})</h4>
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-gray-600">
                          <th className="text-left py-2 px-2 text-gray-400 text-sm font-medium">Room Code</th>
                          <th className="text-left py-2 px-2 text-gray-400 text-sm font-medium">Created</th>
                          <th className="text-left py-2 px-2 text-gray-400 text-sm font-medium">Privacy</th>
                          <th className="text-right py-2 px-2 text-gray-400 text-sm font-medium">STT Cost</th>
                          <th className="text-right py-2 px-2 text-gray-400 text-sm font-medium">MT Cost</th>
                          <th className="text-right py-2 px-2 text-gray-400 text-sm font-medium">Total</th>
                        </tr>
                      </thead>
                      <tbody>
                        {data.rooms.map((room) => (
                          <tr key={room.room_id} className="border-b border-gray-600">
                            <td className="py-2 px-2 text-white text-sm font-medium">{room.room_code}</td>
                            ...
                            <td className="py-2 px-2 text-right text-white text-sm font-semibold">
